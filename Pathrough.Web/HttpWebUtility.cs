...
namespace Pathrough.Web
{
    ...
    public class HttpWebUtility
    {
        ...
        /// </summary>
        /// <param name="wp"></param>
        public HttpWebUtility(WebProxy wp)
            : this()
        {
            this.webProxySrv = wp;
        }
        ...
        public HttpWebUtility(bool cred)
            : this()
        {
            this.certificatedMode = cred;
        }
        public HttpWebUtility(bool cred, WebProxy wp)
            : this()
        {
            this.certificatedMode = cred;
            this.webProxySrv = wp;
        ...
        public HttpWebUtility(bool cred, string certFilepath)
            : this(cred)
        {
            this.certFilepath = certFilepath;
        }
        public HttpWebUtility(bool cred, WebProxy wp, string certFilepath)
            : this(cred, wp)
        {
            this.certFilepath = certFilepath;
        }
        ...
        public HttpWebUtility(string uri, string method, string username, string password)
            : this(true)
        {
        ...
        private void SetHttpRequestOptions(string url, string method, CookieCollection cc, string referUrl, bool nocache, DecompressionMethods dm)
        {
            ...
            //httpRequest.Timeout = ApplicationConfig.HTTP_REQUEST_TIMEOUT;//todo
            // 讀寫超時
            ...
            if (null != this.OnGetPostReadyHandler)
            {
                ...
                catch (System.Exception ex)
                {
                    ...
                    //BaseDebug.DebugPrint(ex.ToString());//todo
                }
            }
        }
        ...
        public MemoryStream GetMemoryStream(string url, string method, CookieCollection cc, string referUrl, string httpAccept)
        {
            ...
            {
                this.LastAccessError = true;
                //BaseDebug.DebugPrint("異常網址:" + url);//todo
                //BaseDebug.DebugPrint(ex.ToString());//todo
