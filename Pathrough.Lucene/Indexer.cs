...
namespace Pathrough.LuceneSE
{
    ...
    {
        //[Obsolete]
        //public static void CreateIndexByData<T>(List<T> list, Action<Document, T> AddField,string indexPath)
        //{
        ...
        public static void CreateIndex(List<Document> docList, string indexPath)
        {
